...
| `WordStudyScreen` | Full offline Word Study route with an RTL ayah ribbon, route-driven/adjacent selection, and a horizontally scrollable Overview/Morphology/Grammar/Occurrences/Dictionary tab list. | `app/study/word/[surah]/[ayah]/[position].tsx` |
