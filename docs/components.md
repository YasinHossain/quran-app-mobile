...
| `WordStudyScreen` | Full offline Word Study route with an RTL ayah ribbon, route-driven/adjacent selection, Overview, Morphology, and Occurrences tabs, source/version details, attributed sharing, reader round-trip restoration, and explicit loading/error/missing states. | `app/study/word/[surah]/[ayah]/[position].tsx` |
