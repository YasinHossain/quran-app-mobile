...
| Tafsir (ayah detail) | `../quran-app/app/(features)/tafsir` | `app/tafsir/[surahId]/[ayahId].tsx` | 90% | Match content order; verse actions (ellipsis menu) available on the verse card (without “View Tafsir”, since the user is already on tafsir). Native sheet/modal presentation is OK. |
